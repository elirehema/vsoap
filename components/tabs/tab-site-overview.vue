<template>
  <v-container class="pa-0 ma-0 pt-4" fluid style="background-color: #f4f4f4">
    <v-row>
...
import SummaryPower from '@/components/summary/summary-power.vue';
